...
public class MYHelpClaimItemListPresenter extends BasePresenter<IMyClaimItemListView> {

    GoogleProgressDialog mProgressDialog;

    public void MyHelpClaimItemListCall(final Context context, String userId) {
        //getView().enableLoadingBar(context, true);
        mProgressDialog = new GoogleProgressDialog(context);
        mProgressDialog.showDialog();

        UTopperApp.getInstance().getApiService().getMyHelpClaimItemList(userId)
    ...
    public void ItemReceivedCall(final Context context, String claimBy, String claimId) {
        ...
        UTopperApp.getInstance().getApiService().callRequestReceived(claimBy, claimId)
