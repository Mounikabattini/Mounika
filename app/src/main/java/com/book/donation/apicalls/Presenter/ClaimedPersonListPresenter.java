...
public class ClaimedPersonListPresenter extends BasePresenter<IClaimedPersonListView> {
    ...
    public void ClaimedPersonListCall(final Context context, String userId, String productId) {
        ...
        UTopperApp.getInstance().getApiService().getClaimedPersonList(userId, productId)
    ...
    public void ClaimAcceptCall(final Context context, String claimBy, String claimId) {
        ...
        UTopperApp.getInstance().getApiService().claimAccept(claimBy, claimId)
