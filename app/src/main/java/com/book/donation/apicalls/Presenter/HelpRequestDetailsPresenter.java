...
public class HelpRequestDetailsPresenter extends BasePresenter<IRequestDetailsView>{
    ...
    public void DetailsCall(final Context context, String userID, String productId, String productType) {
        ...
        UTopperApp.getInstance().getApiService().getRequestDetails(userID, productId, productType)
                .enqueue(new Callback<RequestDetailsResBean>() {
                    @Override
                    public void onResponse(Call<RequestDetailsResBean> call, Response<RequestDetailsResBean> response) {
                    ...
                    @Override
                    public void onFailure(Call<RequestDetailsResBean> call, Throwable t) {
                        try {
                            //getView().enableLoadingBar(context, false);
                            mProgressDialog.dismiss();
                            t.printStackTrace();
    ...
    public void ClaimHelpCall(final Context context, String userID, String productId) {
        //getView().enableLoadingBar(context, true);
        mProgressDialog = new GoogleProgressDialog(context);
        mProgressDialog.showDialog();

        UTopperApp.getInstance().getApiService().claimHelp(userID, productId)
